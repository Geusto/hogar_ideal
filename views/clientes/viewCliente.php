      ...
      <?php foreach ($clientes as $cliente): ?>
          <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow p-6">
              ...
              <i class="fas fa-user mr-2"></i>
                <h3 class="text-xl font-semibold text-gray-800"><?php echo ucfirst($cliente['nombre_completo']); ?></h3>
              </div>
              <div class="flex items-center mb-4">
                <i class="fas fa-envelope mr-2"></i>
                <p class="text-gray-600"><?php echo ucfirst($cliente['email']); ?></p>
              </div>
              <div class="flex items-center mb-4">
                <i class="fas fa-phone mr-2"></i>
                <p class="text-gray-600"><?php echo ucfirst($cliente['telefono']); ?></p>
              </div>
          </div>
      <?php endforeach; ?>
    </div>
